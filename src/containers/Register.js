            ...
            <form onSubmit={handleSubmit}>
              <div className="form-row">
                <div className="col-md-6">
                  <label
                    htmlFor="FirstName"
                    data-trans-key="customer.register.first_name"
                  >
                    User Name
                  </label>
                  <input
              ...
              <div className="form-row">
                <div className="col-md-6">
                  <label
                    htmlFor="email"
                    data-trans-key="customer.register.email"
                  >
                    Email
                  </label>
                  <input
                ...
                <div className="col-md-6">
                  <label
                    htmlFor="review"
                    data-trans-key="customer.register.password"
                  >
                    Password
                  </label>
                  <input
                ...
                <div className="p-3">
                  {currentState.isLoading ? (
                    <button
                      ...
                      data-trans-key="customer.register.submit"
                    >
                      Registering...
                    </button>
                  ) : (
